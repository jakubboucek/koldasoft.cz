  ...
  echo("          <div class=\"text_box\">
          ...
          <div class=\"float_box question\">
            ...
            <ul>
              ...
              <li>oceníme kreativní přístup s&nbsp;pochopením pro technickou implementaci a zaběhlá pravidla</li>
              <li>upřednostňujeme grafiky s&nbsp;citem pro moderní, čistý a svěží design</li>
              <li>základní znalost HTML a CSS výhodou</li>
              <li>vyžadujeme několik hotových referencí (ne nutně komerčního charakteru)</li>
            </ul>  
            <h2 id=\"pozadujeme\">Požadujeme</h2>
            <ul>
              <li>spolehlivost</li>
              <li>komunikativnost</li>
              <li>samostatnost a zároveň i schopnost práce v&nbsp;týmu</li>
              <li>chuť se nadále zlepšovat a učit</li>
              <li>znalost a zkušenost prostředí, ve kterém chcete pracovat (práce by měla být koníčkem)</li>
            </ul>  
            <h2 id=\"nabizime\">Nabízíme</h2>
            <ul>
              <li>práci bez úvazků</li>
              <li>práci dle Vašich možností</li>
              <li>práci doma - <strong>snadno skloubitelnou se studiem</strong></li>
