<?php  //Tvorba webovych stranek
  ...
  echo("          <div class=\"text_box\">
          ...
          <div class=\"text_box\">
            ...
            <p>Našim cílem je Vám v prezentaci na Internetu pomoci&hellip;</p>
            <h2 id=\"optimalizace-seo\">".mylink("optimalizace-pro-vyhledavace")."</h2>
            <p>Stránky, které nikdo nenajde, jakoby nebyly. Našim cílem je stránky optimalizovat pomocí metod SEO tak, aby byly snadno k nalezení <acronym>vyhledávači</acronym> a vyskytovaly se na předních pozicích výsledků vyhledávání. Tato optimalizace je možná důležitější než vlastní web. Lze se velmi snadno zviditelnit a předstihnout tak konkurenci, protože většina návštěvníků (přes 80%), přichází právě přes internetové vyhledávače. ".mylink("optimalizace-pro-vyhledavace", "čtěte dále")."</p>
            <h2 id=\"registrace-do-katalogu\">".mylink("registrace-do-katalogu")."</h2>
            <p>Katalogy jsou jakousi moderní obdobou zlatých stránek v telefonním seznamu. Katalogy jsou určeny k přehlednému utřídění webových stránek podle kategorií. Vybráním kategorie, popř. okresu či jiných specifik, se postupně dostaneme až na seznam hledaných firem.</p>
            <p>Mezi nejznámější české katalogy patří Seznam, Centrum a Atlas. Ze zahraničních katalogů jsou nejznámější Yahoo! a ODP. Existují také katalogy s daným zaměřením. ".mylink("registrace-do-katalogu", "čtěte dále")."</p>
            <h2 id=\"registrace-domeny-hostingu\">".mylink("domeny-hosting", "Registrace domény a zřízení hostingu")."</h2>
            <p>Pokud máte webové stránky hotové, je potřeba je zveřejnit, umístit na internet. Stránky musí být někde fyzicky umístěné (hosting) a musí mít adresu (doména). Poté již stačí, když uživatel zadá Vaši webovou adresu a odpovědí mu budou právě Vaše stránky. ".mylink("domeny-hosting", "čtěte dále")."</p>
            <h2 id=\"redesign\">".mylink("redesign")."</h2>
            <p>Máte své webové stránky? Nevyhovují Vám? Jsou již zastaralé? Máte pocit, že je návštěvnost příliš nízká? Potřebujete stránky předělat? ".mylink("redesign", "čtěte dále")."</p>
            <h2 id=\"nasledna-sprava\">".mylink("nasledna-sprava")."</h2>
