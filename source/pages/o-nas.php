<?php  //O nas
  ...
  echo("          <div class=\"text_box\">
            <h1>$page_name</h1>
            <p>Volba obchodního partnera je vždy těžká. Rádi bychom Vám nabídli informace o tom, kdo jsme a co děláme, seznámili Vás s&nbsp;naším cílem a nabídli důvody pro vzájemnou spolupráci.</p>
            <p>Prohlédněte si ".mylink("reference", "naše reference")." a ujistěte se, zda jsme pro Vás vhodným obchodním partnerem. A my věříme, že jsme&hellip;</p>
          </div>  
          ...
          <div class=\"float_box tip more\">
            ...
            <h2 id=\"kdo-jsme\">Kdo jsme a co děláme</h2>  
            <p>Jsme  ".mylink("nas-tym", "tým zkušených odborníků").", zasahující do mnoha odvětví, s&nbsp;nadšením pro věc. Naší snahou je zdokonalovat své techniky ve prospěch klientů, a tím i zvyšování prestiže naší tvorby. Neustálým zdokonalováním roste kvalita práce a o tu je větší zájem, neboť <strong>ten, kdo požaduje práci, požaduje kvalitní práci</strong>&hellip;</p>
            ...
            <p>Dále Vám můžeme nabídnout širokou škálu ".mylink("graficke-prace", "grafických prací").". Navrhneme Vám a vytvoříme ".mylink("corporate-design", "logo", "logotyp-znacka").", ".mylink("tistena-grafika", "tištěné materiály")." (vizitky, letáčky), vytvoříme prezentaci na CD/DVD. Zabýváme se ".mylink("graficke-prace", "3D grafikou", "grafika-3d", "3D grafika").".</p>
