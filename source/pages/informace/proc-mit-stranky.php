<?php  //Proc mit webove stranky
  ...
  echo("          <div class=\"text_box\">
          ...
          <div class=\"text_box\">
            ...
            <p>Od každé zavedené firmy se očekává, že své webové stránky má. Dnes je prezentace na internetu <strong>naprosto běžná</strong>. Je tedy potřeba vyjít svým zákazníkům vstříc ".mylink("pozadavky-kvalitni-stranky", "kvalitními webovými stránkami").".</p>
            <p>I pro malou začínající firmu se webové stránky vyplatí a umožní jí tak rozlet ve svém oboru.</p>
            <h2 id=\"zvyseni-zisku\">Zvýšení zisků</h2>
