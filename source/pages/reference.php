...
<!--              <ul class=\"link_farm\">
          ...
          <div class=\"text_box\">
            ...
            <div class=\"reference\">
              <div class=\"text\">
                <h3 id=\"ref_psa\">".mylink("pro-sport-activities")."</h3>
            ...
            <div class=\"reference\">
              <div class=\"text\">
                <h3 id=\"ref_domino_eshop\">".mylink("hrackydomino")."</h3>
            ...
            <div class=\"reference\">
              <div class=\"text\">
                <h3 id=\"ref_laki\">".mylink("lakikincl")."</h3>
            ...
            <div class=\"reference\">
              <div class=\"text\">
                <h3 id=\"ref_mathis\">".mylink("mathis")."</h3>
                <p class=\"short\">Projekt nebyl spuštěn.</p>
            ...
            <div class=\"reference\">
              <div class=\"text\">
                <h3 id=\"ref_krystal\">".mylink("krystal")."</h3>
            ...
            <div class=\"reference\">
              <div class=\"text\">
                <h3 id=\"ref_smsrealitni\">".mylink("smsrealitni")."</h3>
          ...
          <div class=\"text_box\">
            ...
            <div class=\"reference\">
              <div class=\"text\">
                <h3 id=\"ref_vrataabrany\">".mylink("vrata-brany")."</h3>
            ...
            <div class=\"reference\">
              <div class=\"text\">
                <h3 id=\"ref_airnet\">".mylink("airnet")."</h3>
            ...
            <div class=\"reference\">
              <div class=\"text\">
                <h3 id=\"ref_plzenske_ohynky\">".mylink("plzenske-ohynky")."</h3>
            ...
            <div class=\"reference\">
              <div class=\"text\">
                <h3>".mylink("zdravotni-poradenstvi")."</h3>
