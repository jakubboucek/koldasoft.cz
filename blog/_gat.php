...
.---------------------------------------------------------------------------.
|  Software: Web CMS                                                        |
|   Version: $Id:: _gat.php 1338 2010-02-08 16:12:48Z jakub.boucek        $ |
|   Contact: info@koldasoft.cz                                              |
|      Info: http://www.koldasoft.cz/                                       |
|   Support: http://www.koldasoft.cz/kontakt/                               |
| ------------------------------------------------------------------------- |
|    Author: Koldasoft, s.r.o.                                              |
|    Author: Jakub Bouček, Jiří Kolařík, Radek Prokeš and someone others    |
...
$stdtracker = NULL;
$newtracker = NULL;
$timebreakpoint = mktime(0, 0, 0, 7, 1, 2009);
$params = array();
