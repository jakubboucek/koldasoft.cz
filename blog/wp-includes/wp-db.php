...
<p>Pokud nevíte jak zprovoznit databázi, měli byste <strong>kontaktovat svého poskytovatele hostingových služeb</strong>. V případě dalších problémů zkuste nalézt řešení na <a href="http://wordpress.org/support/">Fóru podpory WordPressu</a>.</p>'/*/WP_I18N_DB_SELECT_DB*/, $db, DB_USER));
			return;
		}
	}
