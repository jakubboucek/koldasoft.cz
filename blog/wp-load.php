...
if ( file_exists( ABSPATH . 'wp-config.php') ) {
	...
	wp_die(sprintf(/*WP_I18N_NO_CONFIG*/'Pravděpodobně nemáte vytvořen soubor <code>wp-config.php</code>. Než začnete s instalací WordPressu, tak musíte tento soubor vytvořit. Nevíte jak? <a href=\'http://codex.wordpress.org/Editing_wp-config.php\'>Pomoc najdete v manuálu</a>. Můžete také zkusit vytvořit soubor <code>wp-config.php</code> prostřednictvím webového rozhraní, ale tato možnost nefunguje na všech hostingových serverech. Nejbezpečnějším způsobem je vytvoření tohoto souboru manuálně.</p><p><a href=\'%ssetup-config.php\' class=\'button\'>Vytvořit konfigurační soubor</a>'/*/WP_I18N_NO_CONFIG*/, $path), /*WP_I18N_ERROR_TITLE*/'WordPress &rsaquo; Chyba'/*/WP_I18N_ERROR_TITLE*/, array('text_direction' => $text_direction));
