...
if ( version_compare( '4.3', phpversion(), '>' ) ) {
	die( sprintf( /*WP_I18N_OLD_PHP*/'Váš server sice používá PHP verze %s, ale WordPress vyžaduje minimálně verzi 4.3 a vyšší.'/*/WP_I18N_OLD_PHP*/, phpversion() ) );
}
...
if ( !extension_loaded('mysql') && !file_exists(WP_CONTENT_DIR . '/db.php') )
	die( /*WP_I18N_OLD_MYSQL*/'Vypadá to, že ve vaší instalaci PHP chybí rozšíření MySQL, které je však pro fungování WordPressu vyžadováno.'/*/WP_I18N_OLD_MYSQL*/ );
