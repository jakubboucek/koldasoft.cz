<?php  //Informace
  ...
  echo("          <div class=\"text_box\">
          ...
          <div class=\"text_box\">
            ...
            <p>Mít kvalitní webové stránky je základem úspěchu! Zajímá Vás, co si představit pod pojmem <strong>kvalitní webová stránka</strong>? Jak vypadá, jak se pozná a jaké jsou její náležitosti? ".mylink("pozadavky-kvalitni-stranky", "čtěte dále")."</p>
            <h2 id=\"vyhody-nevyhody\">".mylink("vyhody-nevyhody")."</h2>
            <p>Webové stránky se dnes staly opravdu populárními. Avšak se svými tištěnými kolegy toho nemají moc společného. Ba naopak, jedná se o dvě naprosto odlišné formy. Shrňme si jejich výhody a nevýhody&hellip; ".mylink("vyhody-nevyhody", "čtěte dále")."</p>
            <h2 id=\"prubeh-stranek\">".mylink("prubeh-tvorby")."</h2>
            <p>Zajímá Vás, jak taková tvorba webových stránek probíhá? Jaké kroky a náležitosti jsou potřeba. Jak celý proces vypadá? Provedeme Vás tvorbou od prvotního nápadu až k&nbsp;funkční webové stránce. ".mylink("prubeh-tvorby", "čtěte dále")."</p>
            <h2 id=\"naklady-na-provoz\">".mylink("naklady-na-provoz")."</h2>
            <p>Dnes není nic zadarmo a ani provoz webových stránek není výjimkou. Zajímá Vás, jaké poplatky a v&nbsp;jaké výši je třeba platit? Jak často? ".mylink("naklady-na-provoz", "čtěte dále")."</p>
